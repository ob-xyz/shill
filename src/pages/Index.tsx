    ...
    <div className="container">
      ...
      <div className="content">
        <div className="inner-content">
          ...
          <h2>We are a Canadian company that develops and builds new companies for the long haul.<br /><br/>Every day, our companies accelerate technology to drive progress across areas that actually matter to society.</h2>
